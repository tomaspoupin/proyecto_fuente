...
void ui_map_voltage_button(const unsigned char button_pin, const ButtonType type);
void ui_map_current_button(const unsigned char button_pin, const ButtonType type);
